...
| package.json | Insecure Randomness CryptoJS | High | Our version of the amplify library is using insecure random data, fix. | High | 03-Jun-2021 | 03-Dec-2021 | Log ticket XXX |
...
| package.json | React - DNS-Packet - Remote Memory Exposure | High | Although this would be hard to exploit - it provides a possible channel for data exfiltration. We should patch this. | High | 03-Jun-2021 | 03-Dec-2021 | Log ticket |
